...
?>
      ...
      <div class="container">
        ...
        <div class="fd-ai-grid">
          <article class="fd-ai-card reveal-fd">
            ...
            <p>Payroll Management is a core module of EduPortal — AI-ready school management software Pakistan used by hundreds of campuses. Process staff payroll accurately with attendance-linked deductions. It centralizes workflows that schools previously handled with manual payslip math and mismatched leave deductions every month, giving every stakeholder accurate information from a single login.</p>
          </article>
          <article class="fd-ai-card reveal-fd">
            <h2><i data-lucide="star"></i> Why is Payroll Management important for schools?</h2>
            <p>Payroll Management matters because operational mistakes directly affect student experience and school reputation. When records are late or incomplete, parents lose trust, teachers duplicate effort, and owners fly blind on decisions. EduPortal helps schools professionalize back-office work so education stays the focus.</p>
          </article>
          <article class="fd-ai-card reveal-fd">
            <h2><i data-lucide="route"></i> How does EduPortal's Payroll Management work?</h2>
            <p>EduPortal's payroll management connects staff dashboards, optional mobile apps, and parent-facing portals. Administrators configure rules once; daily users complete tasks in simple screens; reports and notifications flow automatically to the right people — principals, accountants, teachers, and families.</p>
          </article>
          <article class="fd-ai-card reveal-fd">
            <h2><i data-lucide="map-pin"></i> Benefits for schools in Pakistan</h2>
            <p>For schools in Pakistan, payroll management must respect local realities: multi-lingual families, WhatsApp as the primary channel, tight fee cycles, and board exam pressure. EduPortal supports Urdu/English workflows, SIM and WhatsApp messaging, PKR billing, and formats familiar to regional education boards — without forcing you to adopt foreign software habits.</p>
          </article>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="fd-benefits-grid">
          ...
          <article class="fd-benefit-card reveal-fd">
            ...
            <p>Automate repetitive payroll management tasks so your office team focuses on students, not spreadsheets.</p>
          </article>

          <article class="fd-benefit-card reveal-fd">
            <div class="fd-benefit-icon"><i data-lucide="shield-check"></i></div>
            <h3>Single source of truth</h3>
            <p>All payroll management data lives inside EduPortal school ERP Pakistan — no duplicate tools or manual sync.</p>
          </article>
          ...
          <article class="fd-benefit-card reveal-fd">
            ...
            <p>Payroll Management connects natively to fees, attendance, exams, and finance — no brittle integrations.</p>
          </article>
        </div>
      </div>
    </section>
    ...
    <section class="fd-cta reveal-fd">
      <div class="container">
        ...
        <h2>Ready to modernize payroll management?</h2>
