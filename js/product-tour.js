...
(function () {
  ...
  // The zoom only makes sense while the frame is sticky beside the steps,
  // which is the >=992px layout. Below that the visual has already scrolled
  // past the step describing it, so panning explains nothing and costs a
  // large-image transform on every scroll frame.
