(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    /* Scroll reveal moved to js/reveal.js, which handles .reveal-fd along
     * with .reveal and .reveal-cs using one threshold and one easing. */

    /* The Get Started modal is handled by js/demo-modal.js, which ships
     * with includes/partials/demo-modal.php so the behaviour always
     * arrives alongside the markup. */
  });
})();
