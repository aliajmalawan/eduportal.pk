...
$pageTitle        = 'School Hostel Management Software | EduPortal ERP Pakistan';
$pageDescription  = 'Room allocation, boarding fees, hostel attendance &amp; warden dashboards for residential schools. EduPortal hostel module in one school ERP Pakistan platform.';
...
$jsonLdSchema = <<<'JSON'
{
    ...
    "@graph": [
        ...
        {
            "@type": "BreadcrumbList",
            "@id": "https://eduportal.pk/hostel-management.php#breadcrumb",
            "itemListElement": [
                {
                    "@type": "ListItem",
                    "position": 1,
                ...
                },
                {
                    ...
                    "item": "https://eduportal.pk/hostel-management.php"
                }
            ]
        },
        {
            "@type": "WebPage",
            "@id": "https://eduportal.pk/hostel-management.php#webpage",
            "name": "School Hostel Management Software | EduPortal ERP Pakistan",
            "description": "Room allocation, boarding fees, hostel attendance &amp; warden dashboards for residential schools. EduPortal hostel module in one school ERP Pakistan platform.",
            "url": "https://eduportal.pk/hostel-management.php",
            "isPartOf": {
                "@id": "https://eduportal.pk/#website"
            }
        }
...
$extraHeadHtml = <<<'HTML'
  ...
  <meta property="og:title" content="School Hostel Management Software | EduPortal ERP Pakistan">
  <meta property="og:description" content="Room allocation, boarding fees, hostel attendance &amp; warden dashboards for residential schools. EduPortal hostel module in one school ERP Pakistan platform.">
...
$moduleFaqs = [
    ['q' => 'What is Hostel Management in EduPortal?',
     'a' => 'Hostel Management in EduPortal is a module within our school management software Pakistan that manage rooms, boarders, fees, and warden operations from one dashboard. It replaces manual room charts, missed hostel fees, and paper leave registers with visible occupancy, linked hostel billing, and warden-friendly workflows.'],
    ['q' => 'Why is Hostel Management important for schools?',
     'a' => 'Schools lose time and money when manual room charts, missed hostel fees, and paper leave registers. Hostel Management gives administrators and teachers one reliable system so leaders can focus on education quality instead of admin firefighting.'],
    ['q' => 'How does EduPortal\'s Hostel Management work?',
     'a' => 'Staff log in to EduPortal web or mobile apps, access the hostel management module, and complete daily tasks in guided screens. Data syncs instantly to reports, parent apps, and related modules like fees or attendance.'],
    ['q' => 'Is EduPortal hostel management suitable for Pakistani schools?',
    ...
    ['q' => 'Can hostel management integrate with other EduPortal modules?',
     'a' => 'Absolutely. Hostel Management shares data with student records, finance, communication, and mobile apps — so you never re-enter the same information twice.'],
    ['q' => 'Do parents see hostel management updates?',
    ...
    ['q' => 'How long does implementation take?',
     'a' => 'Most schools go live within days, not months. Our team provides onboarding, data import assistance, and training tailored to hostel management workflows.'],
    ...
    ['q' => 'Can we customize hostel management for our school?',
    ...
    ['q' => 'How do I see Hostel Management in action?',
...
?>
    ...
    <div class="container fd-breadcrumb">
      <nav aria-label="Breadcrumb">
        <ol>
          ...
          <li><span aria-current="page">Hostel Management</span></li>
        </ol>
      </nav>
    </div>
    ...
    <section class="fd-hero">
      <div class="container fd-hero-grid reveal-fd">
        <div>
          <span class="fd-hero-badge"><i data-lucide="home" style="width:16px;height:16px"></i> School ERP Pakistan</span>
          <h1>Hostel Management — School Management Software Pakistan</h1>
          <p class="fd-hero-lead">Manage rooms, boarders, fees, and warden operations from one dashboard. EduPortal replaces manual room charts, missed hostel fees, and paper leave registers with visible occupancy, linked hostel billing, and warden-friendly workflows for modern schools.</p>
        ...
        <div class="fd-hero-visual">
          <img src="<?= ep_h(ep_url('assets/dashboard.png')) ?>" alt="EduPortal hostel management dashboard" width="640" height="400" loading="eager">
    ...
    <section class="fd-ai-section" aria-labelledby="ai-overview">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="ai-overview">Everything you need to know about Hostel Management</h2>
    ...
    <section class="fd-section fd-section--alt" aria-labelledby="benefits-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="benefits-heading">Why schools choose EduPortal Hostel Management</h2>
    ...
    <section class="fd-section" aria-labelledby="breakdown-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="breakdown-heading">Complete Hostel Management capabilities</h2>
        ...
        <div class="fd-breakdown-grid">
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Room &amp; bed allocation</h3>
              <p>EduPortal hostel management includes room &amp; bed allocation designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Hostel fee billing</h3>
              <p>EduPortal hostel management includes hostel fee billing designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Boarder profiles</h3>
              <p>EduPortal hostel management includes boarder profiles designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal hostel management includes leave requests designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Visitor logs</h3>
              <p>EduPortal hostel management includes visitor logs designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Discipline notes</h3>
              <p>EduPortal hostel management includes discipline notes designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Mess fee linking</h3>
              <p>EduPortal hostel management includes mess fee linking designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal hostel management includes occupancy reports designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Warden mobile view</h3>
              <p>EduPortal hostel management includes warden mobile view designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal hostel management includes parent notifications designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Hostel Management reporting &amp; exports</h3>
              <p>Generate filtered reports and PDF exports for leadership reviews, saving hours compared to manual manual room charts, missed hostel fees, and paper leave registers.</p>
            </div>
          </article>
    ...
    <section class="fd-section fd-section--alt" aria-labelledby="how-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="how-heading">How Hostel Management works in your school</h2>
        ...
        <div class="fd-steps">
          ...
          <article class="fd-step reveal-fd">
            ...
            <p>Define classes, sessions, and rules that match how your campus runs hostel management today.</p>
          </article>
          ...
          <article class="fd-step reveal-fd">
            ...
            <p>Teams use hostel management every day while parents receive updates through app, SMS, or WhatsApp.</p>
          </article>

          <article class="fd-step reveal-fd">
            <h3>Review analytics &amp; optimize</h3>
            <p>Owners use dashboards to refine policies, reduce manual room charts, missed hostel fees, and paper leave registers, and improve visible occupancy, linked hostel billing, and warden-friendly workflows.</p>
          </article>
    ...
    <section class="fd-section" aria-labelledby="why-heading">
      <div class="container fd-prose reveal-fd">
        <h2 id="why-heading">Why schools need Hostel Management</h2>
        <p>Running a school in 2026 means managing more data than ever — yet many campuses still depend on manual room charts, missed hostel fees, and paper leave registers. That creates delays, errors, and frustrated parents who expect instant answers about their children.</p>
        <p>Hostel Management inside EduPortal school ERP Pakistan addresses these gaps directly. Instead of asking staff to juggle WhatsApp groups, registers, and disconnected Excel files, everything flows through one platform designed for educators.</p>
        <p>When visible occupancy, linked hostel billing, and warden-friendly workflows become standard, principals gain confidence during inspections, owners see trustworthy numbers, and teachers spend less time on paperwork. The result is a campus that feels professional to families comparing schools in your city.</p>
        ...
        <ul>
          <li>Eliminate manual room charts, missed hostel fees, and paper leave registers with structured digital workflows.</li>
          <li>Achieve visible occupancy, linked hostel billing, and warden-friendly workflows visible to owners and parents alike.</li>
    ...
    <section class="fd-section fd-section--alt" aria-labelledby="screens-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="screens-heading">Hostel Management screenshots &amp; mockups</h2>
        ...
        <div class="fd-gallery reveal-fd">
          <figure class="fd-gallery-item">
            <img src="<?= ep_h(ep_url('assets/dashboard.png')) ?>" alt="EduPortal hostel management dashboard" width="800" height="500" loading="lazy">
          </figure>
          <figure class="fd-gallery-item">
            <img src="<?= ep_h(ep_url('assets/dashboard.png')) ?>" alt="EduPortal Hostel Management admin dashboard" width="600" height="400" loading="lazy">
          </figure>
          <figure class="fd-gallery-item">
            <div class="fd-gallery-mock">
              <div class="fd-gallery-mock-bars"><span></span><span></span><span></span></div>
              <h4>Hostel Management mobile view</h4>
    ...
    <section class="fd-section" aria-labelledby="faq-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="faq-heading">Hostel Management — frequently asked questions</h2>
        </div>
    ...
    $ctaHeading   = 'Ready to modernize hostel management?';
