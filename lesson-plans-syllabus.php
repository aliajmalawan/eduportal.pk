...
$pageTitle        = 'Lesson Plan &amp; Syllabus Tracking for Schools | EduPortal';
$pageDescription  = 'Teachers log daily lesson plans aligned to syllabus coverage. Academic coordinators monitor progress before board exams with EduPortal school ERP Pakistan.';
...
$epTrackPage      = 'lesson-plans-syllabus';
...
$jsonLdSchema = <<<'JSON'
{
    ...
    "@graph": [
        ...
        {
            "@type": "BreadcrumbList",
            "@id": "https://eduportal.pk/lesson-plans-syllabus.php#breadcrumb",
            "itemListElement": [
                {
                    "@type": "ListItem",
                    "position": 1,
                ...
                },
                {
                    "@type": "ListItem",
                    "position": 3,
                    "name": "Lesson Plans & Syllabus Tracking",
                    "item": "https://eduportal.pk/lesson-plans-syllabus.php"
                }
            ]
        },
        {
            "@type": "WebPage",
            "@id": "https://eduportal.pk/lesson-plans-syllabus.php#webpage",
            "name": "Lesson Plan &amp; Syllabus Tracking for Schools | EduPortal",
            "description": "Teachers log daily lesson plans aligned to syllabus coverage. Academic coordinators monitor progress before board exams with EduPortal school ERP Pakistan.",
            "url": "https://eduportal.pk/lesson-plans-syllabus.php",
            "isPartOf": {
                "@id": "https://eduportal.pk/#website"
            }
        }
...
$extraHeadHtml = <<<'HTML'
  ...
  <meta property="og:title" content="Lesson Plan &amp; Syllabus Tracking for Schools | EduPortal">
  <meta property="og:description" content="Teachers log daily lesson plans aligned to syllabus coverage. Academic coordinators monitor progress before board exams with EduPortal school ERP Pakistan.">
...
$moduleFaqs = [
    ['q' => 'What is Lesson Plans & Syllabus Tracking in EduPortal?',
     'a' => 'Lesson Plans & Syllabus Tracking in EduPortal is a module within our school management software Pakistan that ensure curriculum completion with visible lesson plans and coverage dashboards. It replaces unknown syllabus gaps discovered weeks before board exams with coordinated teaching, visible progress, and inspection-ready documentation.'],
    ['q' => 'Why is Lesson Plans & Syllabus Tracking important for schools?',
     'a' => 'Schools lose time and money when unknown syllabus gaps discovered weeks before board exams. Lesson Plans & Syllabus Tracking gives administrators and teachers one reliable system so leaders can focus on education quality instead of admin firefighting.'],
    ['q' => 'How does EduPortal\'s Lesson Plans & Syllabus Tracking work?',
     'a' => 'Staff log in to EduPortal web or mobile apps, access the lesson plans & syllabus tracking module, and complete daily tasks in guided screens. Data syncs instantly to reports, parent apps, and related modules like fees or attendance.'],
    ['q' => 'Is EduPortal lesson plans & syllabus tracking suitable for Pakistani schools?',
    ...
    ['q' => 'Can lesson plans & syllabus tracking integrate with other EduPortal modules?',
     'a' => 'Absolutely. Lesson Plans & Syllabus Tracking shares data with student records, finance, communication, and mobile apps — so you never re-enter the same information twice.'],
    ['q' => 'Do parents see lesson plans & syllabus tracking updates?',
    ...
    ['q' => 'How long does implementation take?',
     'a' => 'Most schools go live within days, not months. Our team provides onboarding, data import assistance, and training tailored to lesson plans & syllabus tracking workflows.'],
    ...
    ['q' => 'Can we customize lesson plans & syllabus tracking for our school?',
    ...
    ['q' => 'How do I see Lesson Plans & Syllabus Tracking in action?',
...
?>
    ...
    <div class="container fd-breadcrumb">
      <nav aria-label="Breadcrumb">
        <ol>
          ...
          <li><span aria-current="page">Lesson Plans &amp; Syllabus Tracking</span></li>
        </ol>
      </nav>
    </div>
    ...
    <section class="fd-hero">
      <div class="container fd-hero-grid reveal-fd">
        <div>
          <span class="fd-hero-badge"><i data-lucide="book-open" style="width:16px;height:16px"></i> School ERP Pakistan</span>
          <h1>Lesson Plans &amp; Syllabus Tracking — School Management Software Pakistan</h1>
          <p class="fd-hero-lead">Ensure curriculum completion with visible lesson plans and coverage dashboards. EduPortal replaces unknown syllabus gaps discovered weeks before board exams with coordinated teaching, visible progress, and inspection-ready documentation for modern schools.</p>
        ...
        <div class="fd-hero-visual">
          <img src="<?= ep_h(ep_url('assets/dashboard.png')) ?>" alt="EduPortal lesson plan and syllabus tracking" width="640" height="400" loading="eager">
    ...
    <section class="fd-ai-section" aria-labelledby="ai-overview">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="ai-overview">Everything you need to know about Lesson Plans &amp; Syllabus Tracking</h2>
    ...
    <section class="fd-section fd-section--alt" aria-labelledby="benefits-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="benefits-heading">Why schools choose EduPortal Lesson Plans &amp; Syllabus Tracking</h2>
    ...
    <section class="fd-section" aria-labelledby="breakdown-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="breakdown-heading">Complete Lesson Plans &amp; Syllabus Tracking capabilities</h2>
        ...
        <div class="fd-breakdown-grid">
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Daily lesson logs</h3>
              <p>EduPortal lesson plans &amp; syllabus tracking includes daily lesson logs designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal lesson plans &amp; syllabus tracking includes syllabus mapping designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal lesson plans &amp; syllabus tracking includes topic completion % designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal lesson plans &amp; syllabus tracking includes coordinator review designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal lesson plans &amp; syllabus tracking includes resource attachments designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Weekly plans</h3>
              <p>EduPortal lesson plans &amp; syllabus tracking includes weekly plans designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Subject-wise targets</h3>
              <p>EduPortal lesson plans &amp; syllabus tracking includes subject-wise targets designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal lesson plans &amp; syllabus tracking includes inspection reports designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Teacher accountability</h3>
              <p>EduPortal lesson plans &amp; syllabus tracking includes teacher accountability designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Multi-grade templates</h3>
              <p>EduPortal lesson plans &amp; syllabus tracking includes multi-grade templates designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Lesson Plans &amp; Syllabus Tracking reporting &amp; exports</h3>
              <p>Generate filtered reports and PDF exports for leadership reviews, saving hours compared to manual unknown syllabus gaps discovered weeks before board exams.</p>
            </div>
          </article>
    ...
    <section class="fd-section fd-section--alt" aria-labelledby="how-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="how-heading">How Lesson Plans &amp; Syllabus Tracking works in your school</h2>
        ...
        <div class="fd-steps">
          ...
          <article class="fd-step reveal-fd">
            ...
            <p>Define classes, sessions, and rules that match how your campus runs lesson plans &amp; syllabus tracking today.</p>
          </article>
          ...
          <article class="fd-step reveal-fd">
            ...
            <p>Teams use lesson plans &amp; syllabus tracking every day while parents receive updates through app, SMS, or WhatsApp.</p>
          </article>

          <article class="fd-step reveal-fd">
            <h3>Review analytics &amp; optimize</h3>
            <p>Owners use dashboards to refine policies, reduce unknown syllabus gaps discovered weeks before board exams, and improve coordinated teaching, visible progress, and inspection-ready documentation.</p>
          </article>
    ...
    <section class="fd-section" aria-labelledby="why-heading">
      <div class="container fd-prose reveal-fd">
        <h2 id="why-heading">Why schools need Lesson Plans &amp; Syllabus Tracking</h2>
        <p>Running a school in 2026 means managing more data than ever — yet many campuses still depend on unknown syllabus gaps discovered weeks before board exams. That creates delays, errors, and frustrated parents who expect instant answers about their children.</p>
        <p>Lesson Plans &amp; Syllabus Tracking inside EduPortal school ERP Pakistan addresses these gaps directly. Instead of asking staff to juggle WhatsApp groups, registers, and disconnected Excel files, everything flows through one platform designed for educators.</p>
        <p>When coordinated teaching, visible progress, and inspection-ready documentation become standard, principals gain confidence during inspections, owners see trustworthy numbers, and teachers spend less time on paperwork. The result is a campus that feels professional to families comparing schools in your city.</p>
        ...
        <ul>
          <li>Eliminate unknown syllabus gaps discovered weeks before board exams with structured digital workflows.</li>
          <li>Achieve coordinated teaching, visible progress, and inspection-ready documentation visible to owners and parents alike.</li>
    ...
    <section class="fd-section fd-section--alt" aria-labelledby="screens-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="screens-heading">Lesson Plans &amp; Syllabus Tracking screenshots &amp; mockups</h2>
        ...
        <div class="fd-gallery reveal-fd">
          <figure class="fd-gallery-item">
            <img src="<?= ep_h(ep_url('assets/dashboard.png')) ?>" alt="EduPortal lesson plan and syllabus tracking" width="800" height="500" loading="lazy">
          </figure>
          <figure class="fd-gallery-item">
            <img src="<?= ep_h(ep_url('assets/dashboard.png')) ?>" alt="EduPortal Lesson Plans &amp; Syllabus Tracking admin dashboard" width="600" height="400" loading="lazy">
          </figure>
          <figure class="fd-gallery-item">
            <div class="fd-gallery-mock">
              <div class="fd-gallery-mock-bars"><span></span><span></span><span></span></div>
              <h4>Lesson Plans &amp; Syllabus Tracking mobile view</h4>
    ...
    <section class="fd-section" aria-labelledby="faq-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="faq-heading">Lesson Plans &amp; Syllabus Tracking — frequently asked questions</h2>
        </div>
    ...
    $ctaHeading   = 'Ready to modernize lesson plans & syllabus tracking?';
    ...
    <section class="fd-related">
      <div class="container reveal-fd">
        ...
        <div class="fd-related-links"><a href="<?= ep_h(ep_feature_url('lms-management.php')) ?>">Learning Management System (LMS)</a>
<a href="<?= ep_h(ep_feature_url('timetable-management.php')) ?>">Timetable Management</a>
