...
$pageTitle        = 'Exam Datasheets &amp; Roll Number Slips | EduPortal ERP';
$pageDescription  = 'Export exam datasheets, seating plans &amp; roll number slips formatted for board exams. One-click exam coordination for school ERP Pakistan.';
...
$jsonLdSchema = <<<'JSON'
{
    ...
    "@graph": [
        ...
        {
            "@type": "BreadcrumbList",
            "@id": "https://eduportal.pk/exam-datasheets.php#breadcrumb",
            "itemListElement": [
                {
                    "@type": "ListItem",
                    "position": 1,
                ...
                },
                {
                    "@type": "ListItem",
                    "position": 3,
                    "name": "Exam Datasheets & Roll Slips",
                    "item": "https://eduportal.pk/exam-datasheets.php"
                }
            ]
        },
        {
            "@type": "WebPage",
            "@id": "https://eduportal.pk/exam-datasheets.php#webpage",
            "name": "Exam Datasheets &amp; Roll Number Slips | EduPortal ERP",
            "description": "Export exam datasheets, seating plans &amp; roll number slips formatted for board exams. One-click exam coordination for school ERP Pakistan.",
            "url": "https://eduportal.pk/exam-datasheets.php",
            "isPartOf": {
                "@id": "https://eduportal.pk/#website"
            }
        }
...
$extraHeadHtml = <<<'HTML'
  ...
  <meta property="og:title" content="Exam Datasheets &amp; Roll Number Slips | EduPortal ERP">
  <meta property="og:description" content="Export exam datasheets, seating plans &amp; roll number slips formatted for board exams. One-click exam coordination for school ERP Pakistan.">
...
$moduleFaqs = [
    ['q' => 'What is Exam Datasheets & Roll Slips in EduPortal?',
     'a' => 'Exam Datasheets & Roll Slips in EduPortal is a module within our school management software Pakistan that print accurate seating plans and roll slips before exam day in one click. It replaces last-minute seating mistakes and manual roll slip typing with room-wise accuracy, board-ready formats, and coordinator peace of mind.'],
    ['q' => 'Why is Exam Datasheets & Roll Slips important for schools?',
     'a' => 'Schools lose time and money when last-minute seating mistakes and manual roll slip typing. Exam Datasheets & Roll Slips gives administrators and teachers one reliable system so leaders can focus on education quality instead of admin firefighting.'],
    ['q' => 'How does EduPortal\'s Exam Datasheets & Roll Slips work?',
     'a' => 'Staff log in to EduPortal web or mobile apps, access the exam datasheets & roll slips module, and complete daily tasks in guided screens. Data syncs instantly to reports, parent apps, and related modules like fees or attendance.'],
    ['q' => 'Is EduPortal exam datasheets & roll slips suitable for Pakistani schools?',
    ...
    ['q' => 'Can exam datasheets & roll slips integrate with other EduPortal modules?',
     'a' => 'Absolutely. Exam Datasheets & Roll Slips shares data with student records, finance, communication, and mobile apps — so you never re-enter the same information twice.'],
    ['q' => 'Do parents see exam datasheets & roll slips updates?',
    ...
    ['q' => 'How long does implementation take?',
     'a' => 'Most schools go live within days, not months. Our team provides onboarding, data import assistance, and training tailored to exam datasheets & roll slips workflows.'],
    ...
    ['q' => 'Can we customize exam datasheets & roll slips for our school?',
    ...
    ['q' => 'How do I see Exam Datasheets & Roll Slips in action?',
...
?>
    ...
    <div class="container fd-breadcrumb">
      <nav aria-label="Breadcrumb">
        <ol>
          ...
          <li><span aria-current="page">Exam Datasheets &amp; Roll Slips</span></li>
        </ol>
      </nav>
    </div>
    ...
    <section class="fd-hero">
      <div class="container fd-hero-grid reveal-fd">
        <div>
          <span class="fd-hero-badge"><i data-lucide="file-spreadsheet" style="width:16px;height:16px"></i> School ERP Pakistan</span>
          <h1>Exam Datasheets &amp; Roll Slips — School Management Software Pakistan</h1>
          <p class="fd-hero-lead">Print accurate seating plans and roll slips before exam day in one click. EduPortal replaces last-minute seating mistakes and manual roll slip typing with room-wise accuracy, board-ready formats, and coordinator peace of mind for modern schools.</p>
        ...
        <div class="fd-hero-visual">
          <img src="<?= ep_h(ep_url('assets/dashboard.png')) ?>" alt="EduPortal exam datasheets and roll slips" width="640" height="400" loading="eager">
    ...
    <section class="fd-ai-section" aria-labelledby="ai-overview">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="ai-overview">Everything you need to know about Exam Datasheets &amp; Roll Slips</h2>
    ...
    <section class="fd-section fd-section--alt" aria-labelledby="benefits-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="benefits-heading">Why schools choose EduPortal Exam Datasheets &amp; Roll Slips</h2>
    ...
    <section class="fd-section" aria-labelledby="breakdown-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="breakdown-heading">Complete Exam Datasheets &amp; Roll Slips capabilities</h2>
        ...
        <div class="fd-breakdown-grid">
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Datasheet export</h3>
              <p>EduPortal exam datasheets &amp; roll slips includes datasheet export designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Seating plans</h3>
              <p>EduPortal exam datasheets &amp; roll slips includes seating plans designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal exam datasheets &amp; roll slips includes roll number slips designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal exam datasheets &amp; roll slips includes room allocation designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Invigilator lists</h3>
              <p>EduPortal exam datasheets &amp; roll slips includes invigilator lists designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Board format presets</h3>
              <p>EduPortal exam datasheets &amp; roll slips includes board format presets designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Bulk PDF print</h3>
              <p>EduPortal exam datasheets &amp; roll slips includes bulk PDF print designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Student photo sheets</h3>
              <p>EduPortal exam datasheets &amp; roll slips includes student photo sheets designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Subject-wise lists</h3>
              <p>EduPortal exam datasheets &amp; roll slips includes subject-wise lists designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Exam day checklists</h3>
              <p>EduPortal exam datasheets &amp; roll slips includes exam day checklists designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Exam Datasheets &amp; Roll Slips reporting &amp; exports</h3>
              <p>Generate filtered reports and PDF exports for leadership reviews, saving hours compared to manual last-minute seating mistakes and manual roll slip typing.</p>
            </div>
          </article>
    ...
    <section class="fd-section fd-section--alt" aria-labelledby="how-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="how-heading">How Exam Datasheets &amp; Roll Slips works in your school</h2>
        ...
        <div class="fd-steps">
          ...
          <article class="fd-step reveal-fd">
            ...
            <p>Define classes, sessions, and rules that match how your campus runs exam datasheets &amp; roll slips today.</p>
          </article>
          ...
          <article class="fd-step reveal-fd">
            ...
            <p>Teams use exam datasheets &amp; roll slips every day while parents receive updates through app, SMS, or WhatsApp.</p>
          </article>

          <article class="fd-step reveal-fd">
            <h3>Review analytics &amp; optimize</h3>
            <p>Owners use dashboards to refine policies, reduce last-minute seating mistakes and manual roll slip typing, and improve room-wise accuracy, board-ready formats, and coordinator peace of mind.</p>
          </article>
    ...
    <section class="fd-section" aria-labelledby="why-heading">
      <div class="container fd-prose reveal-fd">
        <h2 id="why-heading">Why schools need Exam Datasheets &amp; Roll Slips</h2>
        <p>Running a school in 2026 means managing more data than ever — yet many campuses still depend on last-minute seating mistakes and manual roll slip typing. That creates delays, errors, and frustrated parents who expect instant answers about their children.</p>
        <p>Exam Datasheets &amp; Roll Slips inside EduPortal school ERP Pakistan addresses these gaps directly. Instead of asking staff to juggle WhatsApp groups, registers, and disconnected Excel files, everything flows through one platform designed for educators.</p>
        <p>When room-wise accuracy, board-ready formats, and coordinator peace of mind become standard, principals gain confidence during inspections, owners see trustworthy numbers, and teachers spend less time on paperwork. The result is a campus that feels professional to families comparing schools in your city.</p>
        ...
        <ul>
          <li>Eliminate last-minute seating mistakes and manual roll slip typing with structured digital workflows.</li>
          <li>Achieve room-wise accuracy, board-ready formats, and coordinator peace of mind visible to owners and parents alike.</li>
    ...
    <section class="fd-section fd-section--alt" aria-labelledby="screens-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="screens-heading">Exam Datasheets &amp; Roll Slips screenshots &amp; mockups</h2>
        ...
        <div class="fd-gallery reveal-fd">
          <figure class="fd-gallery-item">
            <img src="<?= ep_h(ep_url('assets/dashboard.png')) ?>" alt="EduPortal exam datasheets and roll slips" width="800" height="500" loading="lazy">
          </figure>
          <figure class="fd-gallery-item">
            <img src="<?= ep_h(ep_url('assets/dashboard.png')) ?>" alt="EduPortal Exam Datasheets &amp; Roll Slips admin dashboard" width="600" height="400" loading="lazy">
          </figure>
          <figure class="fd-gallery-item">
            <div class="fd-gallery-mock">
              <div class="fd-gallery-mock-bars"><span></span><span></span><span></span></div>
              <h4>Exam Datasheets &amp; Roll Slips mobile view</h4>
    ...
    <section class="fd-section" aria-labelledby="faq-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="faq-heading">Exam Datasheets &amp; Roll Slips — frequently asked questions</h2>
        </div>
    ...
    $ctaHeading   = 'Ready to modernize exam datasheets & roll slips?';
    ...
    <section class="fd-related">
      <div class="container reveal-fd">
        ...
        <div class="fd-related-links"><a href="<?= ep_h(ep_feature_url('examination-management.php')) ?>">Examination Management</a>
<a href="<?= ep_h(ep_feature_url('student-information-system.php')) ?>">Student Information System</a>
<a href="<?= ep_h(ep_feature_url('id-cards-generation.php')) ?>">ID Cards Generation</a></div>
      </div>
    </section>
