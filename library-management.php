...
$pageTitle        = 'School Library Management Software | EduPortal ERP Pakistan';
$pageDescription  = 'Catalog books, manage issuance, returns, fines &amp; overdue alerts with EduPortal library module. Complete school ERP Pakistan for modern libraries.';
...
$epTrackPage      = 'library-management';
...
$jsonLdSchema = <<<'JSON'
{
    ...
    "@graph": [
        ...
        {
            "@type": "BreadcrumbList",
            "@id": "https://eduportal.pk/library-management.php#breadcrumb",
            "itemListElement": [
                {
                    "@type": "ListItem",
                    "position": 1,
                ...
                },
                {
                    ...
                    "item": "https://eduportal.pk/library-management.php"
                }
            ]
        },
        {
            "@type": "WebPage",
            "@id": "https://eduportal.pk/library-management.php#webpage",
            "name": "School Library Management Software | EduPortal ERP Pakistan",
            "description": "Catalog books, manage issuance, returns, fines &amp; overdue alerts with EduPortal library module. Complete school ERP Pakistan for modern libraries.",
            "url": "https://eduportal.pk/library-management.php",
            "isPartOf": {
                "@id": "https://eduportal.pk/#website"
            }
        }
...
$extraHeadHtml = <<<'HTML'
  ...
  <meta property="og:title" content="School Library Management Software | EduPortal ERP Pakistan">
  <meta property="og:description" content="Catalog books, manage issuance, returns, fines &amp; overdue alerts with EduPortal library module. Complete school ERP Pakistan for modern libraries.">
...
$moduleFaqs = [
    ['q' => 'What is Library Management in EduPortal?',
     'a' => 'Library Management in EduPortal is a module within our school management software Pakistan that digital catalog, issuance tracking, and overdue reminders without manual registers. It replaces lost books, handwritten ledgers, and uncollected fines with organized catalog, automated due dates, and clear accountability per borrower.'],
    ['q' => 'Why is Library Management important for schools?',
     'a' => 'Schools lose time and money when lost books, handwritten ledgers, and uncollected fines. Library Management gives administrators and teachers one reliable system so leaders can focus on education quality instead of admin firefighting.'],
    ['q' => 'How does EduPortal\'s Library Management work?',
     'a' => 'Staff log in to EduPortal web or mobile apps, access the library management module, and complete daily tasks in guided screens. Data syncs instantly to reports, parent apps, and related modules like fees or attendance.'],
    ['q' => 'Is EduPortal library management suitable for Pakistani schools?',
    ...
    ['q' => 'Can library management integrate with other EduPortal modules?',
     'a' => 'Absolutely. Library Management shares data with student records, finance, communication, and mobile apps — so you never re-enter the same information twice.'],
    ['q' => 'Do parents see library management updates?',
    ...
    ['q' => 'How long does implementation take?',
     'a' => 'Most schools go live within days, not months. Our team provides onboarding, data import assistance, and training tailored to library management workflows.'],
    ...
    ['q' => 'Can we customize library management for our school?',
    ...
    ['q' => 'How do I see Library Management in action?',
...
?>
    ...
    <div class="container fd-breadcrumb">
      <nav aria-label="Breadcrumb">
        <ol>
          ...
          <li><span aria-current="page">Library Management</span></li>
        </ol>
      </nav>
    </div>
    ...
    <section class="fd-hero">
      <div class="container fd-hero-grid reveal-fd">
        <div>
          <span class="fd-hero-badge"><i data-lucide="library" style="width:16px;height:16px"></i> School ERP Pakistan</span>
          <h1>Library Management — School Management Software Pakistan</h1>
          <p class="fd-hero-lead">Digital catalog, issuance tracking, and overdue reminders without manual registers. EduPortal replaces lost books, handwritten ledgers, and uncollected fines with organized catalog, automated due dates, and clear accountability per borrower for modern schools.</p>
        ...
        <div class="fd-hero-visual">
          <img src="<?= ep_h(ep_url('assets/dashboard.png')) ?>" alt="EduPortal library management system" width="640" height="400" loading="eager">
    ...
    <section class="fd-ai-section" aria-labelledby="ai-overview">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="ai-overview">Everything you need to know about Library Management</h2>
    ...
    <section class="fd-section fd-section--alt" aria-labelledby="benefits-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="benefits-heading">Why schools choose EduPortal Library Management</h2>
    ...
    <section class="fd-section" aria-labelledby="breakdown-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="breakdown-heading">Complete Library Management capabilities</h2>
        ...
        <div class="fd-breakdown-grid">
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>ISBN catalog</h3>
              <p>EduPortal library management includes ISBN catalog designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal library management includes book categories designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Student issuance</h3>
              <p>EduPortal library management includes student issuance designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Staff issuance</h3>
              <p>EduPortal library management includes staff issuance designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal library management includes due date tracking designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal library management includes fine calculation designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Overdue SMS</h3>
              <p>EduPortal library management includes overdue SMS designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Stock reports</h3>
              <p>EduPortal library management includes stock reports designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal library management includes barcode support designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Popular titles analytics</h3>
              <p>EduPortal library management includes popular titles analytics designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Library Management reporting &amp; exports</h3>
              <p>Generate filtered reports and PDF exports for leadership reviews, saving hours compared to manual lost books, handwritten ledgers, and uncollected fines.</p>
            </div>
          </article>
    ...
    <section class="fd-section fd-section--alt" aria-labelledby="how-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="how-heading">How Library Management works in your school</h2>
        ...
        <div class="fd-steps">
          ...
          <article class="fd-step reveal-fd">
            ...
            <p>Define classes, sessions, and rules that match how your campus runs library management today.</p>
          </article>
          ...
          <article class="fd-step reveal-fd">
            ...
            <p>Teams use library management every day while parents receive updates through app, SMS, or WhatsApp.</p>
          </article>

          <article class="fd-step reveal-fd">
            <h3>Review analytics &amp; optimize</h3>
            <p>Owners use dashboards to refine policies, reduce lost books, handwritten ledgers, and uncollected fines, and improve organized catalog, automated due dates, and clear accountability per borrower.</p>
          </article>
    ...
    <section class="fd-section" aria-labelledby="why-heading">
      <div class="container fd-prose reveal-fd">
        <h2 id="why-heading">Why schools need Library Management</h2>
        <p>Running a school in 2026 means managing more data than ever — yet many campuses still depend on lost books, handwritten ledgers, and uncollected fines. That creates delays, errors, and frustrated parents who expect instant answers about their children.</p>
        <p>Library Management inside EduPortal school ERP Pakistan addresses these gaps directly. Instead of asking staff to juggle WhatsApp groups, registers, and disconnected Excel files, everything flows through one platform designed for educators.</p>
        <p>When organized catalog, automated due dates, and clear accountability per borrower become standard, principals gain confidence during inspections, owners see trustworthy numbers, and teachers spend less time on paperwork. The result is a campus that feels professional to families comparing schools in your city.</p>
        ...
        <ul>
          <li>Eliminate lost books, handwritten ledgers, and uncollected fines with structured digital workflows.</li>
          <li>Achieve organized catalog, automated due dates, and clear accountability per borrower visible to owners and parents alike.</li>
    ...
    <section class="fd-section fd-section--alt" aria-labelledby="screens-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="screens-heading">Library Management screenshots &amp; mockups</h2>
        ...
        <div class="fd-gallery reveal-fd">
          <figure class="fd-gallery-item">
            <img src="<?= ep_h(ep_url('assets/dashboard.png')) ?>" alt="EduPortal library management system" width="800" height="500" loading="lazy">
          </figure>
          <figure class="fd-gallery-item">
            <img src="<?= ep_h(ep_url('assets/dashboard.png')) ?>" alt="EduPortal Library Management admin dashboard" width="600" height="400" loading="lazy">
          </figure>
          <figure class="fd-gallery-item">
            <div class="fd-gallery-mock">
              <div class="fd-gallery-mock-bars"><span></span><span></span><span></span></div>
              <h4>Library Management mobile view</h4>
    ...
    <section class="fd-section" aria-labelledby="faq-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="faq-heading">Library Management — frequently asked questions</h2>
        </div>
    ...
    $ctaHeading   = 'Ready to modernize library management?';
...
<a href="<?= ep_h(ep_feature_url('sms-messaging.php')) ?>">SMS Messaging</a></div>
      </div>
    </section>
