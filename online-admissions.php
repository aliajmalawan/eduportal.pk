...
$pageTitle        = 'Online School Admissions Software Pakistan | EduPortal ERP';
$pageDescription  = 'Digitize school admissions with EduPortal — online forms, document upload, merit lists, fee linking &amp; enrollment workflows. School ERP Pakistan built for admission season.';
...
$jsonLdSchema = <<<'JSON'
{
    ...
    "@graph": [
        ...
        {
            "@type": "BreadcrumbList",
            "@id": "https://eduportal.pk/online-admissions.php#breadcrumb",
            "itemListElement": [
                {
                    "@type": "ListItem",
                    "position": 1,
                ...
                },
                {
                    ...
                    "item": "https://eduportal.pk/online-admissions.php"
                }
            ]
        },
        {
            "@type": "WebPage",
            "@id": "https://eduportal.pk/online-admissions.php#webpage",
            "name": "Online School Admissions Software Pakistan | EduPortal ERP",
            "description": "Digitize school admissions with EduPortal — online forms, document upload, merit lists, fee linking &amp; enrollment workflows. School ERP Pakistan built for admission season.",
            "url": "https://eduportal.pk/online-admissions.php",
            "isPartOf": {
                "@id": "https://eduportal.pk/#website"
            }
        }
...
$extraHeadHtml = <<<'HTML'
  ...
  <meta property="og:title" content="Online School Admissions Software Pakistan | EduPortal ERP">
  <meta property="og:description" content="Digitize school admissions with EduPortal — online forms, document upload, merit lists, fee linking &amp; enrollment workflows. School ERP Pakistan built for admission season.">
...
$moduleFaqs = [
    ['q' => 'What is Online Admissions in EduPortal?',
     'a' => 'Online Admissions in EduPortal is a module within our school management software Pakistan that capture inquiries, process applications, and enroll students without paper chaos. It replaces long admission queues, manual form sorting, and enrollment errors every April with faster enrollment, organized merit lists, and linked fee accounts from day one.'],
    ['q' => 'Why is Online Admissions important for schools?',
     'a' => 'Schools lose time and money when long admission queues, manual form sorting, and enrollment errors every April. Online Admissions gives administrators and teachers one reliable system so leaders can focus on education quality instead of admin firefighting.'],
    ['q' => 'How does EduPortal\'s Online Admissions work?',
     'a' => 'Staff log in to EduPortal web or mobile apps, access the online admissions module, and complete daily tasks in guided screens. Data syncs instantly to reports, parent apps, and related modules like fees or attendance.'],
    ['q' => 'Is EduPortal online admissions suitable for Pakistani schools?',
    ...
    ['q' => 'Can online admissions integrate with other EduPortal modules?',
     'a' => 'Absolutely. Online Admissions shares data with student records, finance, communication, and mobile apps — so you never re-enter the same information twice.'],
    ['q' => 'Do parents see online admissions updates?',
    ...
    ['q' => 'How long does implementation take?',
     'a' => 'Most schools go live within days, not months. Our team provides onboarding, data import assistance, and training tailored to online admissions workflows.'],
    ...
    ['q' => 'Can we customize online admissions for our school?',
    ...
    ['q' => 'How do I see Online Admissions in action?',
...
?>
    ...
    <div class="container fd-breadcrumb">
      <nav aria-label="Breadcrumb">
        <ol>
          ...
          <li><span aria-current="page">Online Admissions</span></li>
        </ol>
      </nav>
    </div>
    ...
    <section class="fd-hero">
      <div class="container fd-hero-grid reveal-fd">
        <div>
          <span class="fd-hero-badge"><i data-lucide="user-plus" style="width:16px;height:16px"></i> School ERP Pakistan</span>
          <h1>Online Admissions — School Management Software Pakistan</h1>
          <p class="fd-hero-lead">Capture inquiries, process applications, and enroll students without paper chaos. EduPortal replaces long admission queues, manual form sorting, and enrollment errors every April with faster enrollment, organized merit lists, and linked fee accounts from day one for modern schools.</p>
        ...
        <div class="fd-hero-visual">
          <img src="<?= ep_h(ep_url('assets/dashboard.png')) ?>" alt="EduPortal online admissions workflow" width="640" height="400" loading="eager">
    ...
    <section class="fd-ai-section" aria-labelledby="ai-overview">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="ai-overview">Everything you need to know about Online Admissions</h2>
    ...
    <section class="fd-section fd-section--alt" aria-labelledby="benefits-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="benefits-heading">Why schools choose EduPortal Online Admissions</h2>
    ...
    <section class="fd-section" aria-labelledby="breakdown-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="breakdown-heading">Complete Online Admissions capabilities</h2>
        ...
        <div class="fd-breakdown-grid">
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal online admissions includes online application forms designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal online admissions includes document verification designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Merit list generation</h3>
              <p>EduPortal online admissions includes merit list generation designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal online admissions includes interview scheduling designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Admission fee collection</h3>
              <p>EduPortal online admissions includes admission fee collection designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Seat capacity tracking</h3>
              <p>EduPortal online admissions includes seat capacity tracking designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal online admissions includes waitlist management designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>SMS status updates</h3>
              <p>EduPortal online admissions includes SMS status updates designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Enrollment to SIS sync</h3>
              <p>EduPortal online admissions includes enrollment to SIS sync designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Multi-campus intake</h3>
              <p>EduPortal online admissions includes multi-campus intake designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Online Admissions reporting &amp; exports</h3>
              <p>Generate filtered reports and PDF exports for leadership reviews, saving hours compared to manual long admission queues, manual form sorting, and enrollment errors every April.</p>
            </div>
          </article>
    ...
    <section class="fd-section fd-section--alt" aria-labelledby="how-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="how-heading">How Online Admissions works in your school</h2>
        ...
        <div class="fd-steps">
          ...
          <article class="fd-step reveal-fd">
            ...
            <p>Define classes, sessions, and rules that match how your campus runs online admissions today.</p>
          </article>
          ...
          <article class="fd-step reveal-fd">
            ...
            <p>Teams use online admissions every day while parents receive updates through app, SMS, or WhatsApp.</p>
          </article>

          <article class="fd-step reveal-fd">
            <h3>Review analytics &amp; optimize</h3>
            <p>Owners use dashboards to refine policies, reduce long admission queues, manual form sorting, and enrollment errors every April, and improve faster enrollment, organized merit lists, and linked fee accounts from day one.</p>
          </article>
    ...
    <section class="fd-section" aria-labelledby="why-heading">
      <div class="container fd-prose reveal-fd">
        <h2 id="why-heading">Why schools need Online Admissions</h2>
        <p>Running a school in 2026 means managing more data than ever — yet many campuses still depend on long admission queues, manual form sorting, and enrollment errors every April. That creates delays, errors, and frustrated parents who expect instant answers about their children.</p>
        <p>Online Admissions inside EduPortal school ERP Pakistan addresses these gaps directly. Instead of asking staff to juggle WhatsApp groups, registers, and disconnected Excel files, everything flows through one platform designed for educators.</p>
        <p>When faster enrollment, organized merit lists, and linked fee accounts from day one become standard, principals gain confidence during inspections, owners see trustworthy numbers, and teachers spend less time on paperwork. The result is a campus that feels professional to families comparing schools in your city.</p>
        ...
        <ul>
          <li>Eliminate long admission queues, manual form sorting, and enrollment errors every April with structured digital workflows.</li>
          <li>Achieve faster enrollment, organized merit lists, and linked fee accounts from day one visible to owners and parents alike.</li>
    ...
    <section class="fd-section fd-section--alt" aria-labelledby="screens-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="screens-heading">Online Admissions screenshots &amp; mockups</h2>
        ...
        <div class="fd-gallery reveal-fd">
          <figure class="fd-gallery-item">
            <img src="<?= ep_h(ep_url('assets/dashboard.png')) ?>" alt="EduPortal online admissions workflow" width="800" height="500" loading="lazy">
          </figure>
          <figure class="fd-gallery-item">
            <img src="<?= ep_h(ep_url('assets/dashboard.png')) ?>" alt="EduPortal Online Admissions admin dashboard" width="600" height="400" loading="lazy">
          </figure>
          <figure class="fd-gallery-item">
            <div class="fd-gallery-mock">
              <div class="fd-gallery-mock-bars"><span></span><span></span><span></span></div>
              <h4>Online Admissions mobile view</h4>
    ...
    <section class="fd-section" aria-labelledby="faq-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="faq-heading">Online Admissions — frequently asked questions</h2>
        </div>
    ...
    $ctaHeading   = 'Ready to modernize online admissions?';
    ...
    <section class="fd-related">
      <div class="container reveal-fd">
        ...
        <div class="fd-related-links"><a href="<?= ep_h(ep_feature_url('student-information-system.php')) ?>">Student Information System</a>
<a href="<?= ep_h(ep_feature_url('fee-management.php')) ?>">Fee Management</a>
<a href="<?= ep_h(ep_feature_url('whatsapp-communication.php')) ?>">WhatsApp Communication</a></div>
      </div>
    </section>
