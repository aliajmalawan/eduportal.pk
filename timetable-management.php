...
$pageTitle        = 'School Timetable Software Pakistan | EduPortal ERP';
$pageDescription  = 'Build clash-free timetables for teachers, rooms &amp; sections. EduPortal timetable module keeps staff and students aligned across your school ERP Pakistan.';
...
$epTrackPage      = 'timetable-management';
...
$jsonLdSchema = <<<'JSON'
{
    ...
    "@graph": [
        ...
        {
            "@type": "BreadcrumbList",
            "@id": "https://eduportal.pk/timetable-management.php#breadcrumb",
            "itemListElement": [
                {
                    "@type": "ListItem",
                    "position": 1,
                ...
                },
                {
                    ...
                    "item": "https://eduportal.pk/timetable-management.php"
                }
            ]
        },
        {
            "@type": "WebPage",
            "@id": "https://eduportal.pk/timetable-management.php#webpage",
            "name": "School Timetable Software Pakistan | EduPortal ERP",
            "description": "Build clash-free timetables for teachers, rooms &amp; sections. EduPortal timetable module keeps staff and students aligned across your school ERP Pakistan.",
            "url": "https://eduportal.pk/timetable-management.php",
            "isPartOf": {
                "@id": "https://eduportal.pk/#website"
            }
        }
...
$extraHeadHtml = <<<'HTML'
  ...
  <meta property="og:title" content="School Timetable Software Pakistan | EduPortal ERP">
  <meta property="og:description" content="Build clash-free timetables for teachers, rooms &amp; sections. EduPortal timetable module keeps staff and students aligned across your school ERP Pakistan.">
...
$moduleFaqs = [
    ['q' => 'What is Timetable Management in EduPortal?',
     'a' => 'Timetable Management in EduPortal is a module within our school management software Pakistan that drag-and-drop schedules that avoid conflicts and sync to mobile apps. It replaces double-booked teachers, last-minute sticky notes, and confused substitute plans with conflict-free timetables, live updates, and coordinated substitutions.'],
    ['q' => 'Why is Timetable Management important for schools?',
     'a' => 'Schools lose time and money when double-booked teachers, last-minute sticky notes, and confused substitute plans. Timetable Management gives administrators and teachers one reliable system so leaders can focus on education quality instead of admin firefighting.'],
    ['q' => 'How does EduPortal\'s Timetable Management work?',
     'a' => 'Staff log in to EduPortal web or mobile apps, access the timetable management module, and complete daily tasks in guided screens. Data syncs instantly to reports, parent apps, and related modules like fees or attendance.'],
    ['q' => 'Is EduPortal timetable management suitable for Pakistani schools?',
    ...
    ['q' => 'Can timetable management integrate with other EduPortal modules?',
     'a' => 'Absolutely. Timetable Management shares data with student records, finance, communication, and mobile apps — so you never re-enter the same information twice.'],
    ['q' => 'Do parents see timetable management updates?',
    ...
    ['q' => 'How long does implementation take?',
     'a' => 'Most schools go live within days, not months. Our team provides onboarding, data import assistance, and training tailored to timetable management workflows.'],
    ...
    ['q' => 'Can we customize timetable management for our school?',
    ...
    ['q' => 'How do I see Timetable Management in action?',
...
?>
    ...
    <div class="container fd-breadcrumb">
      <nav aria-label="Breadcrumb">
        <ol>
          ...
          <li><span aria-current="page">Timetable Management</span></li>
        </ol>
      </nav>
    </div>
    ...
    <section class="fd-hero">
      <div class="container fd-hero-grid reveal-fd">
        <div>
          <span class="fd-hero-badge"><i data-lucide="calendar-days" style="width:16px;height:16px"></i> School ERP Pakistan</span>
          <h1>Timetable Management — School Management Software Pakistan</h1>
          <p class="fd-hero-lead">Drag-and-drop schedules that avoid conflicts and sync to mobile apps. EduPortal replaces double-booked teachers, last-minute sticky notes, and confused substitute plans with conflict-free timetables, live updates, and coordinated substitutions for modern schools.</p>
        ...
        <div class="fd-hero-visual">
          <img src="<?= ep_h(ep_url('assets/dashboard.png')) ?>" alt="EduPortal timetable and scheduling" width="640" height="400" loading="eager">
    ...
    <section class="fd-ai-section" aria-labelledby="ai-overview">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="ai-overview">Everything you need to know about Timetable Management</h2>
    ...
    <section class="fd-section fd-section--alt" aria-labelledby="benefits-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="benefits-heading">Why schools choose EduPortal Timetable Management</h2>
    ...
    <section class="fd-section" aria-labelledby="breakdown-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="breakdown-heading">Complete Timetable Management capabilities</h2>
        ...
        <div class="fd-breakdown-grid">
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal timetable management includes period configuration designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal timetable management includes room allocation designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Teacher load balancing</h3>
              <p>EduPortal timetable management includes teacher load balancing designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Section timetables</h3>
              <p>EduPortal timetable management includes section timetables designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Substitution tracking</h3>
              <p>EduPortal timetable management includes substitution tracking designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Mobile timetable view</h3>
              <p>EduPortal timetable management includes mobile timetable view designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>PDF export</h3>
              <p>EduPortal timetable management includes PDF export designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Multi-shift support</h3>
              <p>EduPortal timetable management includes multi-shift support designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Lab scheduling</h3>
              <p>EduPortal timetable management includes lab scheduling designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Exam week layouts</h3>
              <p>EduPortal timetable management includes exam week layouts designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Timetable Management reporting &amp; exports</h3>
              <p>Generate filtered reports and PDF exports for leadership reviews, saving hours compared to manual double-booked teachers, last-minute sticky notes, and confused substitute plans.</p>
            </div>
          </article>
    ...
    <section class="fd-section fd-section--alt" aria-labelledby="how-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="how-heading">How Timetable Management works in your school</h2>
        ...
        <div class="fd-steps">
          ...
          <article class="fd-step reveal-fd">
            ...
            <p>Define classes, sessions, and rules that match how your campus runs timetable management today.</p>
          </article>
          ...
          <article class="fd-step reveal-fd">
            ...
            <p>Teams use timetable management every day while parents receive updates through app, SMS, or WhatsApp.</p>
          </article>

          <article class="fd-step reveal-fd">
            <h3>Review analytics &amp; optimize</h3>
            <p>Owners use dashboards to refine policies, reduce double-booked teachers, last-minute sticky notes, and confused substitute plans, and improve conflict-free timetables, live updates, and coordinated substitutions.</p>
          </article>
    ...
    <section class="fd-section" aria-labelledby="why-heading">
      <div class="container fd-prose reveal-fd">
        <h2 id="why-heading">Why schools need Timetable Management</h2>
        <p>Running a school in 2026 means managing more data than ever — yet many campuses still depend on double-booked teachers, last-minute sticky notes, and confused substitute plans. That creates delays, errors, and frustrated parents who expect instant answers about their children.</p>
        <p>Timetable Management inside EduPortal school ERP Pakistan addresses these gaps directly. Instead of asking staff to juggle WhatsApp groups, registers, and disconnected Excel files, everything flows through one platform designed for educators.</p>
        <p>When conflict-free timetables, live updates, and coordinated substitutions become standard, principals gain confidence during inspections, owners see trustworthy numbers, and teachers spend less time on paperwork. The result is a campus that feels professional to families comparing schools in your city.</p>
        ...
        <ul>
          <li>Eliminate double-booked teachers, last-minute sticky notes, and confused substitute plans with structured digital workflows.</li>
          <li>Achieve conflict-free timetables, live updates, and coordinated substitutions visible to owners and parents alike.</li>
    ...
    <section class="fd-section fd-section--alt" aria-labelledby="screens-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="screens-heading">Timetable Management screenshots &amp; mockups</h2>
        ...
        <div class="fd-gallery reveal-fd">
          <figure class="fd-gallery-item">
            <img src="<?= ep_h(ep_url('assets/dashboard.png')) ?>" alt="EduPortal timetable and scheduling" width="800" height="500" loading="lazy">
          </figure>
          <figure class="fd-gallery-item">
            <img src="<?= ep_h(ep_url('assets/dashboard.png')) ?>" alt="EduPortal Timetable Management admin dashboard" width="600" height="400" loading="lazy">
          </figure>
          <figure class="fd-gallery-item">
            <div class="fd-gallery-mock">
              <div class="fd-gallery-mock-bars"><span></span><span></span><span></span></div>
              <h4>Timetable Management mobile view</h4>
    ...
    <section class="fd-section" aria-labelledby="faq-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="faq-heading">Timetable Management — frequently asked questions</h2>
        </div>
    ...
    $ctaHeading   = 'Ready to modernize timetable management?';
...
<a href="<?= ep_h(ep_feature_url('lesson-plans-syllabus.php')) ?>">Lesson Plans &amp; Syllabus Tracking</a>
<a href="<?= ep_h(ep_feature_url('attendance-management.php')) ?>">Attendance Management</a></div>
      </div>
    </section>
