...
$pageTitle        = 'School Accounting Software Pakistan | EduPortal Finance ERP';
$pageDescription  = 'General ledger, chart of accounts &amp; financial statements for schools. EduPortal accounting module — no separate software needed. School ERP Pakistan.';
...
$epTrackPage      = 'accounting-management';
...
$jsonLdSchema = <<<'JSON'
{
    ...
    "@graph": [
        ...
        {
            "@type": "BreadcrumbList",
            "@id": "https://eduportal.pk/accounting-management.php#breadcrumb",
            "itemListElement": [
                {
                    "@type": "ListItem",
                    "position": 1,
                ...
                },
                {
                    ...
                    "item": "https://eduportal.pk/accounting-management.php"
                }
            ]
        },
        {
            "@type": "WebPage",
            "@id": "https://eduportal.pk/accounting-management.php#webpage",
            "name": "School Accounting Software Pakistan | EduPortal Finance ERP",
            "description": "General ledger, chart of accounts &amp; financial statements for schools. EduPortal accounting module — no separate software needed. School ERP Pakistan.",
            "url": "https://eduportal.pk/accounting-management.php",
            "isPartOf": {
                "@id": "https://eduportal.pk/#website"
            }
        }
...
$extraHeadHtml = <<<'HTML'
  ...
  <meta property="og:title" content="School Accounting Software Pakistan | EduPortal Finance ERP">
  <meta property="og:description" content="General ledger, chart of accounts &amp; financial statements for schools. EduPortal accounting module — no separate software needed. School ERP Pakistan.">
...
$moduleFaqs = [
    ['q' => 'What is Accounting Management in EduPortal?',
     'a' => 'Accounting Management in EduPortal is a module within our school management software Pakistan that run school accounts with ledger, statements, and auditor-ready reports. It replaces fee income in one tool and expenses in another with no single truth with unified books, automated statements, and owner-ready financial clarity.'],
    ['q' => 'Why is Accounting Management important for schools?',
     'a' => 'Schools lose time and money when fee income in one tool and expenses in another with no single truth. Accounting Management gives administrators and teachers one reliable system so leaders can focus on education quality instead of admin firefighting.'],
    ['q' => 'How does EduPortal\'s Accounting Management work?',
     'a' => 'Staff log in to EduPortal web or mobile apps, access the accounting management module, and complete daily tasks in guided screens. Data syncs instantly to reports, parent apps, and related modules like fees or attendance.'],
    ['q' => 'Is EduPortal accounting management suitable for Pakistani schools?',
    ...
    ['q' => 'Can accounting management integrate with other EduPortal modules?',
     'a' => 'Absolutely. Accounting Management shares data with student records, finance, communication, and mobile apps — so you never re-enter the same information twice.'],
    ['q' => 'Do parents see accounting management updates?',
    ...
    ['q' => 'How long does implementation take?',
     'a' => 'Most schools go live within days, not months. Our team provides onboarding, data import assistance, and training tailored to accounting management workflows.'],
    ...
    ['q' => 'Can we customize accounting management for our school?',
    ...
    ['q' => 'How do I see Accounting Management in action?',
...
?>
    ...
    <div class="container fd-breadcrumb">
      <nav aria-label="Breadcrumb">
        <ol>
          ...
          <li><span aria-current="page">Accounting Management</span></li>
        </ol>
      </nav>
    </div>
    ...
    <section class="fd-hero">
      <div class="container fd-hero-grid reveal-fd">
        <div>
          <span class="fd-hero-badge"><i data-lucide="landmark" style="width:16px;height:16px"></i> School ERP Pakistan</span>
          <h1>Accounting Management — School Management Software Pakistan</h1>
          <p class="fd-hero-lead">Run school accounts with ledger, statements, and auditor-ready reports. EduPortal replaces fee income in one tool and expenses in another with no single truth with unified books, automated statements, and owner-ready financial clarity for modern schools.</p>
        ...
        <div class="fd-hero-visual">
          <img src="<?= ep_h(ep_url('assets/dashboard.png')) ?>" alt="EduPortal school accounting and finance" width="640" height="400" loading="eager">
    ...
    <section class="fd-ai-section" aria-labelledby="ai-overview">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="ai-overview">Everything you need to know about Accounting Management</h2>
    ...
    <section class="fd-section fd-section--alt" aria-labelledby="benefits-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="benefits-heading">Why schools choose EduPortal Accounting Management</h2>
    ...
    <section class="fd-section" aria-labelledby="breakdown-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="breakdown-heading">Complete Accounting Management capabilities</h2>
        ...
        <div class="fd-breakdown-grid">
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal accounting management includes chart of accounts designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal accounting management includes journal entries designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal accounting management includes bank reconciliation designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Balance sheet</h3>
              <p>EduPortal accounting management includes balance sheet designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Profit &amp; loss</h3>
              <p>EduPortal accounting management includes profit &amp; loss designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Cash flow</h3>
              <p>EduPortal accounting management includes cash flow designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Fee-to-ledger sync</h3>
              <p>EduPortal accounting management includes fee-to-ledger sync designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Voucher printing</h3>
              <p>EduPortal accounting management includes voucher printing designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Multi-year archives</h3>
              <p>EduPortal accounting management includes multi-year archives designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              ...
              <p>EduPortal accounting management includes auditor export designed for daily school operations in Pakistan — simple for staff, powerful for administrators.</p>
            </div>
          </article>
          ...
          <article class="fd-breakdown-item reveal-fd">
            ...
            <div>
              <h3>Accounting Management reporting &amp; exports</h3>
              <p>Generate filtered reports and PDF exports for leadership reviews, saving hours compared to manual fee income in one tool and expenses in another with no single truth.</p>
            </div>
          </article>
    ...
    <section class="fd-section fd-section--alt" aria-labelledby="how-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="how-heading">How Accounting Management works in your school</h2>
        ...
        <div class="fd-steps">
          ...
          <article class="fd-step reveal-fd">
            ...
            <p>Define classes, sessions, and rules that match how your campus runs accounting management today.</p>
          </article>
          ...
          <article class="fd-step reveal-fd">
            ...
            <p>Teams use accounting management every day while parents receive updates through app, SMS, or WhatsApp.</p>
          </article>

          <article class="fd-step reveal-fd">
            <h3>Review analytics &amp; optimize</h3>
            <p>Owners use dashboards to refine policies, reduce fee income in one tool and expenses in another with no single truth, and improve unified books, automated statements, and owner-ready financial clarity.</p>
          </article>
    ...
    <section class="fd-section" aria-labelledby="why-heading">
      <div class="container fd-prose reveal-fd">
        <h2 id="why-heading">Why schools need Accounting Management</h2>
        <p>Running a school in 2026 means managing more data than ever — yet many campuses still depend on fee income in one tool and expenses in another with no single truth. That creates delays, errors, and frustrated parents who expect instant answers about their children.</p>
        <p>Accounting Management inside EduPortal school ERP Pakistan addresses these gaps directly. Instead of asking staff to juggle WhatsApp groups, registers, and disconnected Excel files, everything flows through one platform designed for educators.</p>
        <p>When unified books, automated statements, and owner-ready financial clarity become standard, principals gain confidence during inspections, owners see trustworthy numbers, and teachers spend less time on paperwork. The result is a campus that feels professional to families comparing schools in your city.</p>
        ...
        <ul>
          <li>Eliminate fee income in one tool and expenses in another with no single truth with structured digital workflows.</li>
          <li>Achieve unified books, automated statements, and owner-ready financial clarity visible to owners and parents alike.</li>
    ...
    <section class="fd-section fd-section--alt" aria-labelledby="screens-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="screens-heading">Accounting Management screenshots &amp; mockups</h2>
        ...
        <div class="fd-gallery reveal-fd">
          <figure class="fd-gallery-item">
            <img src="<?= ep_h(ep_url('assets/dashboard.png')) ?>" alt="EduPortal school accounting and finance" width="800" height="500" loading="lazy">
          </figure>
          <figure class="fd-gallery-item">
            <img src="<?= ep_h(ep_url('assets/dashboard.png')) ?>" alt="EduPortal Accounting Management admin dashboard" width="600" height="400" loading="lazy">
          </figure>
          <figure class="fd-gallery-item">
            <div class="fd-gallery-mock">
              <div class="fd-gallery-mock-bars"><span></span><span></span><span></span></div>
              <h4>Accounting Management mobile view</h4>
    ...
    <section class="fd-section" aria-labelledby="faq-heading">
      <div class="container">
        <div class="fd-section-header reveal-fd">
          ...
          <h2 id="faq-heading">Accounting Management — frequently asked questions</h2>
        </div>
    ...
    $ctaHeading   = 'Ready to modernize accounting management?';
...
<a href="<?= ep_h(ep_feature_url('expenses-profit-loss.php')) ?>">Expenses &amp; Profit/Loss Tracking</a>
<a href="<?= ep_h(ep_feature_url('payroll-management.php')) ?>">Payroll Management</a></div>
      </div>
    </section>
